...
const AboutSection = () => {
  ...
  const timeline = [
    { year: '1985', event: 'Fundação da Óticas Levy na Rua Augusta' },
                ...
                >
                  <Card className="card-premium text-center group hover-lift">
                    <CardContent className="p-8">
                      ...
                      <h4 className="font-serif-elegant text-lg font-semibold mb-3 group-hover:text-primary transition-colors">
                        {value.title}
                      </h4>
        ...
        <AnimatedSection animation="fade-up">
          ...
          <div className="max-w-4xl mx-auto">
            <div className="relative">
              {/* Timeline Line */}
              <div className="absolute left-8 top-0 bottom-0 w-0.5 bg-gradient-to-b from-primary via-primary to-primary/20"></div>
                  ...
                  >
                    <div className="relative flex items-center group">
                      ...
                      <div className="ml-8 card-premium p-6 flex-1 group-hover:shadow-elegant transition-all duration-500">
                        <p className="text-foreground font-medium group-hover:text-primary transition-colors">{item.event}</p>
                      </div>
                    </div>
                  </AnimatedSection>
                ))}
